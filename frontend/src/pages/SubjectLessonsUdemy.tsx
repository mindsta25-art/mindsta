...
import { getQuizByLessonId, getQuizzesByFilters, type Quiz } from "@/api/quizzes";
  ...
  useEffect(() => {
    const fetchLessonsAndProgress = async () => {
      ...
      try {
        ...
        console.log('[SubjectLessons] Access check result:', accessCheck);
        console.log('[SubjectLessons] User enrollments:', user);
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button
                          onClick={() => {
                            ...
                            console.log('Mark as complete:', selectedLesson.id);
                          }}
                        ...
                        >
                          ...
                          {isLessonCompleted(selectedLesson.id) ? 'Completed' : 'Complete'}
                        </Button>
                      </div>
                    </div>
                  </div>
                ...
                <div className="mb-6">
                  <div className="bg-gradient-to-br from-purple-100 via-pink-50 to-orange-50 dark:from-purple-950/30 dark:via-pink-950/20 dark:to-orange-950/20 p-8 border-b">
                    <div className="container mx-auto px-4 max-w-5xl">
                      ...
                      <p className="text-muted-foreground mb-6">
                        Master {subjectName} concepts for Grade {gradeParam}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {lessons.length > 0 && lessons[0].overview ? (
                        ...
                        <p className="text-muted-foreground">
                          This comprehensive {subjectName} course is designed for Grade {gradeParam} students
                          to build a strong foundation and excel in their studies. Through engaging lessons
                          and interactive content, you'll master key concepts and develop problem-solving skills.
                        </p>
                      )}
                      ...
                      <div className="border-t pt-4">
                        ...
                        {lessons.length > 0 && lessons[0].whatYouWillLearn && lessons[0].whatYouWillLearn.length > 0 ? (
                          ...
                          <ul className="space-y-2">
                            ...
                            <li className="flex items-start gap-2">
                              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                              <span>Problem-solving techniques and strategies</span>
                            </li>
                            <li className="flex items-start gap-2">
                              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                            ...
                            <li className="flex items-start gap-2">
                              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                              <span>Exam preparation and test-taking skills</span>
                            </li>
                          </ul>
                        )}
                      </div>
                  ...
                  {selectedLesson ? (
                    loadingQuiz ? (
                      ...
                      <Card>
                        <CardContent className="py-16 text-center">
                          ...
                          <p className="text-xl font-bold text-muted-foreground mb-2">No quiz available</p>
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <div className="text-center py-12">
                          <Brain className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
                          <p className="text-muted-foreground mb-2">Choose a lesson to view its quiz</p>
                          <p className="text-sm text-muted-foreground">Click on any lesson in the Course Content panel</p>
                        </div>
                      </CardContent>
                    </Card>
                          ...
                          <div className="space-y-2">
                            {quizzes.map((quiz, index) => {
                              return (
                                <div
                                  ...
                                  className={`p-3 rounded-lg border cursor-pointer transition-all ${
                                    selectedQuiz?.id === quiz.id
                                      ...
                                      : 'hover:bg-muted border-purple-200 dark:border-purple-900'
                                  }`}
                                  onClick={() => {
                                    ...
                                    // Load quiz questions
                                    const mapped = (quiz.questions || []).map((q: any, idx: number) => ({
                                      id: q.id || String(idx + 1),
                                      question: q.question,
                                      options: q.options,
                                      correct_answer: q.options[q.correctAnswer] ?? '',
                                ...
                                >
                                  <div className="flex items-start gap-2">
                                    <div className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold mt-0.5 bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300">
                                      {index + 1}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                      <h4 className="font-medium text-sm leading-tight mb-1">
